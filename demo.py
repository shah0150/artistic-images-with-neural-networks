...
# Input of Content Image
file_content_image = "adesh_shah.jpg";
print("Content Image" ,file_content_image)
# Input of Style Image
file_style_image = "umbrella_girl.jpg";
print("Style Image ",file_style_image)

# Parameters
# Propoortion noise to apply to content image
input_noise = 0.1
weight_style = 2e2
...
# VGG19 mean for standarisation (RGB)
VGG19_mean = np.array([123.68, 116.779, 103.939]).reshape((1,1,1,3))

# number of checkpoints
n_checkpoints = 10 
# learning iterations per checkpoint           
n_iterations_checkpoint = 10  
# directory to write checkpoint images into 
path_output = 'output'  
